...
export default function About() {
  return (
    <section className="py-20 px-6 bg-transparent">
      <div className="max-w-4xl mx-auto text-center p-8 sm:p-12 rounded-3xl bg-[#020610]/80 backdrop-blur-xl border border-[#d4af37]/25 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
        <h2 className="font-cinzel text-3xl sm:text-5xl font-bold text-[#f3e5ab] mb-4 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
          About Renaissance
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={idx} className="p-4 rounded-xl bg-[#041021]/90 border border-[#d4af37]/25 backdrop-blur-md shadow-lg">
              <span className="font-mono text-2xl sm:text-3xl font-bold text-[#d4af37] block drop-shadow-[0_0_8px_rgba(212,175,55,0.3)]">
                {item.value}
              </span>
