...
export default function LoginSuccess() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-[#f3e5ab] flex flex-col items-center justify-center p-4">
      ...
      <h2 className="font-cinzel text-2xl font-bold text-[#f3e5ab] mb-2 tracking-wide">
