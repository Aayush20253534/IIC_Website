...
export default function Events({ embedded = false }) {
  ...
  return (
    <div
      className={`relative w-full min-h-screen bg-[#030914] text-[#EAD8B1] font-serif overflow-hidden select-none ${
        embedded ? "py-8" : "pt-12 pb-12"
      }`}
    >
      {/* Background Effects */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#030914] via-[#07172B] to-[#02060E] pointer-events-none z-0" />
      <div 
