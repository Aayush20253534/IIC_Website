            ...
            <div key={tier.id} className="text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {tier.sponsors.map((sponsor, sIdx) => (
                  ...
                  >
                    <div className="w-36 h-20 bg-[#050B14] p-2 rounded-lg flex items-center justify-center mb-3.5 border border-[#C5A25F]/20">
                      <img
                        src={sponsor.image}
                        alt={sponsor.name}
                    ...
                    <span className="text-[11px] text-[#0EA5E9] font-mono mt-1 uppercase tracking-wide">
                      {sponsor.category}
                    </span>
                  </div>
                ))}
