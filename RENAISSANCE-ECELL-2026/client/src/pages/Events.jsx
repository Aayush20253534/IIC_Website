                      ...
                      <div className="mt-5 flex flex-col gap-2.5 sm:flex-row">
                        {selectedEventModal.registrationUrl ? (
                          <a
                            ...
                            className="flex-1 border border-[#0c5870] bg-[#0c5870] px-4 py-3 text-center font-cinzel text-[10px] font-black uppercase tracking-[0.14em] text-white shadow-[0_7px_18px_rgba(12,88,112,.2)] transition hover:bg-[#08485d]"
                          >
                            Enter Event
                          </a>
                        ) : (
